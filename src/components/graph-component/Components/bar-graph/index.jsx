...
import BestBar from "../../graphs/BestBar/graphWrapper.jsx";
const BarGraph = ({
  data,
  legend = false,
  legendData,
      ...
      >
        ...
        <BestBar
          ...
          config={{
            ...
            enableTextOverBar: enableTextOverBar,
            textOverBarColor: textOverBarColor,
            textOverBarFontSize: textOverBarFontSize,
            ...
            hideTicks: true,
            activeYLabel: hoveredYLabel || activeYLabel,
            hideYAxis: hideYAxis,
            hideXAxis: hideXAxis,
